 ...
 * @Package com.suntak.cloud.recruitment.entity 
 * @Description: TODO
 * @date Jun 17, 2019 11:08:46 AM 
 * @author <a href="mailto:android_li@sina.cn">Joe</a>
 */
public class Formmain_6902 {
    private String field0001;// 公司logo
    private String field0002;// 所属公司
    private String field0003;// 编号
    private String field0004;// 姓名
    private String field0005;// 曾用名
    private String field0006;// 性别
    private String field0007;// 出生日期
    private String field0008;// 身份证号
...
//    private String field0022;// 农村户
    ...
    private String field0026;// 目前住址
    private String field0027;// 身高
    private String field0028;// 体重
    private String field0029;// 视力
    private String field0030;// 有无职业病史
    private String field0031;// 有无犯罪史
    private String field0032;// 目前有无怀孕
    private String field0033;// 职业病史说明
    private String field0034;// 普通话
    private String field0035;// 英语级
    private String field0036;// 日语级
    private String field0037;// 其它
    private String field0038;// 其他语言能力
    private String field0039;// 技术职称或职业资格
    private String field0040;// 个人特长或爱好
    private String field0041;// 紧急联系人姓名
    private String field0042;// 紧急联系人与本人关系
    private String field0043;// 紧急联系人工作单位或部门
    private String field0044;// 紧急联系人职务
    private String field0045;// 紧急联系人电话
    private String field0046;// 亲属在本公司是否
    private String field0047;// 亲属在本公司姓名
    private String field0048;// 亲属在本公司部门
    private String field0049;// 亲属在本公司职位
    private String field0050;// 亲属在本公司关系
    private String field0051;// 应聘人签名
    private String field0052;// 填表日期
    private String field0053;// 普通话级别
    private String field0054;// 英语级级别
    private String field0055;// 日语级级别
    private String field0056;// 初试评价1
    private String field0057;// 初试评价2
    private String field0058;// 初试评价3
    private String field0059;// 初试评价4
    private String field0060;// 初试评价5
    private String field0061;// 初试评价6
    private String field0062;// 初试评价7
    private String field0063;// 初试评价8
    private String field0064;// 身份证
    private String field0065;// 毕业证
    private String field0066;// 学位证
    private String field0067;// 其它证书
    private String field0068;// 其它证书名称
    private Timestamp field0069;// 可到职日期
    private String field0070;// 初试综合评价
    private String field0071;// 初试结果
    private String field0072;// 面试人
    private Timestamp field0073;// 面试日期
    private String field0074;// 复试评价1
    private String field0075;// 复试评价2
    private String field0076;// 复试评价3
    private String field0077;// 复试评价4
    private String field0078;// 复试评价5
    private String field0079;// 复试综合评价
    private String field0080;// 是否录用
    private String field0081;// 不录用意见
    private String field0082;// 其它意见
    private String field0083;// 意见
    private String field0084;// 复试人
    private Timestamp field0085;// 复试日期
    private String field0086;// 录用公司
    private String field0087;// 录用部门
    private String field0088;// 录用课别
    private String field0089;// 职务工种
    private String field0090;// 职级
    private String field0091;// 试用期
    private String field0092;// 包月固定工资
    private String field0093;// 基本工资制
    private String field0094;// 底薪
    private String field0095;// 岗位津贴
    private String field0096;// 技能工资
    private String field0097;// 部门主管
    private String field0098;// 部门经理
    private String field0099;// 部门总监
    private String field0100;// 工厂总经理
    private String field0101;// 副总裁
    ...
    public String getField0065() {
        return field0065;
    }
    public void setField0065(String field0065) {
        this.field0065 = field0065;
    }
    ...
    public String getField0068() {
        return field0068;
    }
    public void setField0068(String field0068) {
        this.field0068 = field0068;
    }
    public Timestamp getField0069() {
        return field0069;
    }
    public void setField0069(Timestamp field0069) {
        this.field0069 = field0069;
    }
    public String getField0070() {
        return field0070;
    }
    public void setField0070(String field0070) {
        this.field0070 = field0070;
    }
    ...
    public void setField0072(String field0072) {
        this.field0072 = field0072;
    }
    public Timestamp getField0073() {
        return field0073;
    }
    public void setField0073(Timestamp field0073) {
        this.field0073 = field0073;
    }
    public String getField0074() {
        return field0074;
    }
    public void setField0074(String field0074) {
        this.field0074 = field0074;
    }
    public String getField0075() {
        return field0075;
    }
    public void setField0075(String field0075) {
        this.field0075 = field0075;
    }
    public String getField0076() {
        return field0076;
    }
    public void setField0076(String field0076) {
        this.field0076 = field0076;
    }
    public String getField0077() {
        return field0077;
    }
    public void setField0077(String field0077) {
        this.field0077 = field0077;
    }
    public String getField0078() {
        return field0078;
    }
    public void setField0078(String field0078) {
        this.field0078 = field0078;
    }
    public String getField0079() {
        return field0079;
    }
    public void setField0079(String field0079) {
        this.field0079 = field0079;
    }
    public String getField0080() {
        return field0080;
    }
    public void setField0080(String field0080) {
        this.field0080 = field0080;
    }
    public String getField0081() {
        return field0081;
    }
    public void setField0081(String field0081) {
        this.field0081 = field0081;
    }
    ...
    public String getField0084() {
        return field0084;
    }
    public void setField0084(String field0084) {
        this.field0084 = field0084;
    }
    public Timestamp getField0085() {
        return field0085;
    }
    public void setField0085(Timestamp field0085) {
        this.field0085 = field0085;
    }
    public String getField0086() {
        return field0086;
    }
    public void setField0086(String field0086) {
        this.field0086 = field0086;
    }
    public String getField0087() {
        return field0087;
    }
    public void setField0087(String field0087) {
        this.field0087 = field0087;
    }
    public String getField0088() {
        return field0088;
    }
    public void setField0088(String field0088) {
        this.field0088 = field0088;
    }
    public String getField0089() {
        return field0089;
    }
    public void setField0089(String field0089) {
        this.field0089 = field0089;
    }
    public String getField0090() {
        return field0090;
    }
    public void setField0090(String field0090) {
        this.field0090 = field0090;
    }
    public String getField0091() {
        return field0091;
    }
    public void setField0091(String field0091) {
        this.field0091 = field0091;
    }
    public String getField0092() {
        return field0092;
    }
    public void setField0092(String field0092) {
        this.field0092 = field0092;
    }
    public String getField0093() {
        return field0093;
    }
    public void setField0093(String field0093) {
        this.field0093 = field0093;
    }
    public String getField0094() {
        return field0094;
    }
    public void setField0094(String field0094) {
        this.field0094 = field0094;
    }
    public String getField0095() {
        return field0095;
    }
    public void setField0095(String field0095) {
        this.field0095 = field0095;
    }
    public String getField0096() {
        return field0096;
    }
    public void setField0096(String field0096) {
        this.field0096 = field0096;
    }
    public String getField0097() {
        return field0097;
    }
    public void setField0097(String field0097) {
        this.field0097 = field0097;
    }
    public String getField0098() {
        return field0098;
    }
    public void setField0098(String field0098) {
        this.field0098 = field0098;
    }
    public String getField0099() {
        return field0099;
    }
    public void setField0099(String field0099) {
        this.field0099 = field0099;
    }
    public String getField0100() {
        return field0100;
    }
    public void setField0100(String field0100) {
        this.field0100 = field0100;
    }
    public String getField0101() {
        return field0101;
    }
    public void setField0101(String field0101) {
        this.field0101 = field0101;
    }
    public String getField0102() {
        return field0102;
    }
    public void setField0102(String field0102) {
        this.field0102 = field0102;
    }
