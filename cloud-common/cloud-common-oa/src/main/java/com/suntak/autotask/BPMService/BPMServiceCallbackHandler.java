...
/**
 * BPMServiceCallbackHandler Callback class, Users can extend this class and
...
public abstract class BPMServiceCallbackHandler {
	 ...
	 * receiveThirdpartyForm operation
	 */
	public void receiveResultreceiveThirdpartyForm(
			com.suntak.autotask.BPMService.BPMServiceStub.ReceiveThirdpartyFormResponse result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling
	 * error response from receiveThirdpartyForm operation
	 */
	 ...
	 * override this method for handling normal response from
	 * launchHtmlCollaboration operation
	 */
	public void receiveResultlaunchHtmlCollaboration(
			com.suntak.autotask.BPMService.BPMServiceStub.LaunchHtmlCollaborationResponse result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling
	 * error response from launchHtmlCollaboration operation
	 */
	public void receiveErrorlaunchHtmlCollaboration(java.lang.Exception e) {
	}

	/**
	 * auto generated Axis2 call back method for getFormCollIdsByDateTimeRest
	 * method override this method for handling normal response from
	 * getFormCollIdsByDateTimeRest operation
	 */
	public void receiveResultgetFormCollIdsByDateTimeRest(
			com.suntak.autotask.BPMService.BPMServiceStub.GetFormCollIdsByDateTimeRestResponse result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling
	 * error response from getFormCollIdsByDateTimeRest operation
	 */
	 ...
	 * override this method for handling normal response from
	 * getTemplateDefinition operation
	 */
	public void receiveResultgetTemplateDefinition(
			com.suntak.autotask.BPMService.BPMServiceStub.GetTemplateDefinitionResponse result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling
	 * error response from getTemplateDefinition operation
	 */
	 ...
	 * override this method for handling normal response from
	 * launchFormCollaboration operation
	 */
	public void receiveResultlaunchFormCollaboration(
			com.suntak.autotask.BPMService.BPMServiceStub.LaunchFormCollaborationResponse result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling
	 * error response from launchFormCollaboration operation
	 */
	public void receiveErrorlaunchFormCollaboration(java.lang.Exception e) {
	}

	/**
	 * auto generated Axis2 call back method for getFlowState method override
	 * this method for handling normal response from getFlowState operation
	 */
	public void receiveResultgetFlowState(com.suntak.autotask.BPMService.BPMServiceStub.GetFlowStateResponse result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling
	 * error response from getFlowState operation
	 */
	 ...
	 * override this method for handling normal response from
	 * getFormCollIdsByDateTime operation
	 */
	public void receiveResultgetFormCollIdsByDateTime(
			com.suntak.autotask.BPMService.BPMServiceStub.GetFormCollIdsByDateTimeResponse result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling
	 * error response from getFormCollIdsByDateTime operation
	 */
